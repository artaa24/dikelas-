    ...
    <aside class="w-64 bg-white border-r border-gray-100 flex flex-col justify-between h-full flex-shrink-0 transition-all duration-300">
        <div>
            ...
            <nav class="px-4 space-y-2">
                ...
                <a href="/bookmarks" class="flex items-center px-4 py-3 bg-[#9AE6F1] text-[#0A4B7D] rounded-xl font-medium transition-colors">
                    <svg class="w-5 h-5 mr-4" fill="currentColor" viewBox="0 0 20 20"><path d="M5 4a2 2 0 012-2h6a2 2 0 012 2v14l-5-2.5L5 18V4z"></path></svg>
                    Bookmark
                </a>
            </nav>
        </div>
    ...
    <main class="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <div class="flex-1 overflow-auto hide-scrollbar p-8 xl:p-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <!-- Item 1 -->
                <div class="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition relative group">
                    <button class="absolute top-6 right-6 text-yellow-500 hover:text-gray-400 transition">
                    ...
                    <span class="inline-block px-2 py-1 bg-gray-100 text-gray-600 text-xs font-bold rounded mb-2">Algoritma & Pemrograman</span>
                    <h3 class="font-bold text-gray-900 text-lg mb-1 group-hover:text-[#007cc3] transition line-clamp-1">Modul 3: Struktur Kontrol Percabangan</h3>
                    <p class="text-xs text-gray-500 mb-4">Disimpan pada: 25 Okt 2026</p>
                    <a href="/material-detail" class="inline-flex w-full justify-center items-center px-4 py-2 bg-white border border-[#007cc3] text-[#007cc3] text-sm font-semibold rounded-xl hover:bg-blue-50 transition">
                        Buka Materi
                    </a>
                </div>
                ...
                <div class="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition relative group">
                    ...
                    <div class="w-12 h-12 bg-purple-50 text-purple-500 rounded-xl flex items-center justify-center mb-4">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    </div>
                    <span class="inline-block px-2 py-1 bg-gray-100 text-gray-600 text-xs font-bold rounded mb-2">Matematika Diskrit</span>
                    <h3 class="font-bold text-gray-900 text-lg mb-1 group-hover:text-[#007cc3] transition line-clamp-1">Video Penjelasan Teori Graf</h3>
                    <p class="text-xs text-gray-500 mb-4">Disimpan pada: 20 Okt 2026</p>
                    <a href="/material-detail" class="inline-flex w-full justify-center items-center px-4 py-2 bg-white border border-[#007cc3] text-[#007cc3] text-sm font-semibold rounded-xl hover:bg-blue-50 transition">
                        Buka Materi
                    </a>
                </div>
