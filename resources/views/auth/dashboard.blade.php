    ...
    <aside class="w-64 bg-white border-r border-gray-100 flex flex-col justify-between h-full flex-shrink-0">
        <div>
            ...
            <nav class="px-4 space-y-2">
                <a href="/dashboard" class="flex items-center px-4 py-3 bg-[#9AE6F1] text-[#0A4B7D] rounded-xl font-medium transition-colors">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
                        ...
                        <div class="p-6 flex-1 flex flex-col">
                            ...
                            <a href="/class-detail" class="w-full bg-[#007cc3] hover:bg-blue-700 text-white font-bold py-3 rounded-full flex items-center justify-center transition mt-auto text-sm">
