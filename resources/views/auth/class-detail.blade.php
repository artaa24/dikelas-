                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        ...
                        <div class="p-2 bg-white">
                            <!-- Items inside module -->
                            <a href="#" class="flex items-center px-4 py-3 hover:bg-gray-50 rounded-xl transition group">
                    ...
                    <div class="bg-white rounded-2xl border-2 border-[#007cc3] shadow-md overflow-hidden">
                        ...
                        <div class="p-2 bg-white border-t border-gray-100">
                            <a href="#" class="flex items-center px-4 py-3 bg-blue-50/50 rounded-xl transition group">
                            ...
                            <a href="#" class="flex items-center px-4 py-3 bg-white hover:bg-gray-50 rounded-xl transition group border-l-2 border-blue-500 shadow-sm my-1">
