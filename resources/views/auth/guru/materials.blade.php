                        ...
                        <tbody class="text-sm">
                            ...
                            <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition">
                                ...
                                <td class="p-5 text-right flex justify-end space-x-1">
                                    ...
                                    <form action="/guru/materials/{{ $material->id }}" method="POST" class="inline" onsubmit="confirmAction(event, this, 'Apakah Anda yakin ingin menghapus materi ini?', 'Hapus', '#d33')">
                                        @csrf
                                        @method('DELETE')
