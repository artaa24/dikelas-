    ...
    <main class="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <header class="h-20 bg-white flex items-center justify-between px-8 xl:px-10 flex-shrink-0 border-b border-gray-100">
            ...
            <div class="flex-1 max-w-2xl">
                <div class="relative">
                    ...
                    <input type="text" class="w-full bg-gray-50 border border-gray-200 rounded-full py-3 pl-12 pr-4 text-sm focus:outline-none focus:ring-1 focus:ring-[#007cc3]" placeholder="Cari nama murid atau NISN...">
                </div>
            </div>
        ...
        <div class="flex-1 overflow-auto hide-scrollbar p-8 xl:p-10">
            ...
            <div class="flex justify-between items-end mb-8">
                <div>
                    <h2 class="text-3xl font-bold text-gray-900 mb-2">Anggota Kelas</h2>
                    <p class="text-gray-500">Kelola daftar murid yang terdaftar dalam mata pelajaran Anda.</p>
                </div>
                <a href="/guru/add-student" class="bg-[#007cc3] hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg shadow-blue-500/30 flex items-center transition">
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                    <h3 class="font-bold text-gray-900">Daftar Murid Terdaftar</h3>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-sm text-gray-500">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50/50 border-b border-gray-100">
                            <tr>
                                <th scope="col" class="px-6 py-4 rounded-tl-lg">Profil Murid</th>
                                <th scope="col" class="px-6 py-4">NISN</th>
                                <th scope="col" class="px-6 py-4">Status</th>
                                <th scope="col" class="px-6 py-4 text-center">Rata-rata Nilai</th>
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b border-gray-50 hover:bg-gray-50 transition">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <img class="h-10 w-10 rounded-full object-cover mr-3" src="https://i.pravatar.cc/150?img=11" alt="Student">
                                        <div>
                                            <p class="font-bold text-gray-900">Budi Santoso</p>
                                            <p class="text-xs text-gray-500">budi@student.dikelas.com</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 font-medium">1029384756</td>
                                <td class="px-6 py-4">
                                    <span class="bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs font-bold">Aktif</span>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <span class="font-bold text-gray-900 text-base">85.5</span>
                                </td>
                                <td class="px-6 py-4 text-right">
                                    <button class="text-gray-400 hover:text-red-500 transition ml-4" title="Keluarkan Murid">
                            ...
                            <tr class="bg-white border-b border-gray-50 hover:bg-gray-50 transition">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <img class="h-10 w-10 rounded-full object-cover mr-3" src="https://i.pravatar.cc/150?img=5" alt="Student">
                                        <div>
                                            <p class="font-bold text-gray-900">Siti Aminah</p>
                                            <p class="text-xs text-gray-500">siti.a@student.dikelas.com</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 font-medium">1029384757</td>
                                <td class="px-6 py-4">
                                    <span class="bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs font-bold">Aktif</span>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <span class="font-bold text-[#007cc3] text-base">92.0</span>
                                </td>
                                <td class="px-6 py-4 text-right">
                                    <button class="text-gray-400 hover:text-red-500 transition ml-4" title="Keluarkan Murid">
                                        <svg class="w-5 h-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
