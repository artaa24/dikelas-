                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden flex flex-col group hover:shadow-md transition-shadow relative">
                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        ...
                        <div class="mt-auto">
                            ...
                            <button class="w-full bg-gray-50 border border-gray-200 text-gray-600 hover:bg-gray-100 font-semibold py-2.5 rounded-xl flex items-center justify-center transition-colors text-sm">
                                Lihat Ulang Materi
                            </button>
                        </div>
                    </div>
