    <aside class="w-64 bg-white border-r border-gray-100 flex flex-col justify-between h-full flex-shrink-0">
        <div>
            ...
            <nav class="px-4 space-y-2">
                <a href="/dashboard" class="flex items-center px-4 py-3 rounded-xl font-medium transition-colors {{ ($active ?? '') == 'dashboard' ? 'bg-[#9AE6F1] text-[#0A4B7D]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                ...
                <a href="/courses" class="flex items-center px-4 py-3 rounded-xl font-medium transition-colors {{ ($active ?? '') == 'courses' ? 'bg-[#9AE6F1] text-[#0A4B7D]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                    <svg class="w-5 h-5 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                    Kursus Saya
                </a>
                <a href="/schedule" class="flex items-center px-4 py-3 rounded-xl font-medium transition-colors {{ ($active ?? '') == 'schedule' ? 'bg-[#9AE6F1] text-[#0A4B7D]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                ...
                <a href="/assignments" class="flex items-center px-4 py-3 rounded-xl font-medium transition-colors {{ ($active ?? '') == 'assignments' ? 'bg-[#9AE6F1] text-[#0A4B7D]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                    <svg class="w-5 h-5 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
                    Tugasku
                </a>
                <a href="/grades" class="flex items-center px-4 py-3 rounded-xl font-medium transition-colors {{ ($active ?? '') == 'grades' ? 'bg-[#9AE6F1] text-[#0A4B7D]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                ...
                <a href="/certificates" class="flex items-center px-4 py-3 rounded-xl font-medium transition-colors {{ ($active ?? '') == 'certificates' ? 'bg-[#9AE6F1] text-[#0A4B7D]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
